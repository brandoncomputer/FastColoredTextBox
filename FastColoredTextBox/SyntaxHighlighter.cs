         ...
         //   CSharpCommentRegex2 = new Regex(@"(<\#(.*))+", RegexOptions.Multiline | RegexCompiledOption);
           ...
           CSharpCommentRegex3 = new Regex(@"(/\#.*?\#/)|(.*\#/)",
            ...
            //  CSharpCommentRegex4 = new Regex(@"<\#.*$", RegexOptions.Multiline | RegexCompiledOption);
             ...
             //  CSharpCommentRegex4 = new Regex(@"(\<\#)+(.|\n)*(\#\>$)", RegexOptions.Multiline | RegexCompiledOption | RegexOptions.RightToLeft);
            //CSharpCommentRegex4 = new Regex(@"(<\#)+(.|\n)*(\#>)+", RegexOptions.Multiline | RegexCompiledOption);
...
//CSharpCommentRegex2 = new Regex(@"(<\#(.*)+)|((.|\n*)\#>$)", RegexOptions.Multiline | RegexCompiledOption);
            ...
            //  CSharpCommentRegex2 = new Regex(@"(?s)<\#.*?\#>", RegexOptions.Singleline | RegexOptions.RightToLeft | RegexCompiledOption);
            //  CSharpCommentRegex4 = new Regex(@"(?s)<\#.*?\#>", RegexOptions.Multiline);
...
";
            ...
            range.SetStyle(ClassNameStyle2, CSharpClassNameRegex1);
